  ...
  return (
    ...
    <Fragment>
      <section className="container cnt_hder">
        ...
        <h2><b>CONTACT</b></h2>
        <p>Our team will happily assist you with ideal recommendations for your needs.</p>
      ...
      <section className="container">
        ...
        <div className="row">
          ...
          <div className="col-md-4">
            <div className="box_sdw">
              <h3>Bengaluru</h3>
              <p>No: 22, Kumaran Business Center,
                12th B Main,HAL 2nd Stage ,
                Indra Nagar ,Bangalore -560008
              </p>

              <p>Mail :
                <b>deepak@squarenet.in</b>
              </p>
              <p>Contact :
                <b>(+91)73583 93657</b>
              </p>
          ...
          <div className="col-md-4">
            <div className="box_sdw">
              ...
              <p>Contact :
                <b>(+91)+91-4344-222743 / (+91)9600007747</b>
              </p>
            </div>
          </div>
